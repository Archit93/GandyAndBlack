...
export const exportCRM = async ({ dispatch, authToken }) => {
  ...
  const apiUrl = `${baseUrl}/order/downloadcrm`;
  apiRequestHeader = {
    ...apiRequestHeader,
    responseType: 'blob'
  }
  ...
  await axios
    ...
    .then((apiResponse) => {
      ...
      fileSaver.saveAs(fileData, "CRM.xlsx");
    ...
    .catch(() => {
      ...
      dispatch({
        ...
        payload: "error",
        message: "There was some error while exporting the CRM .",
      });
    });
};
