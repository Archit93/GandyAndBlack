...
const AboutUs = (props) => {
    return(
		...
		<div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 container-fluid" id="values">
		...
		<div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 container-fluid bg-dark-grey" id="contact">
			<div className="container">
				<div className="text-center"><h1 className="font-weight-bolder">CONTACT US</h1></div>
