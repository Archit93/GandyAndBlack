...
const CompletedOrdersPharma = (props) => {
  const history = useHistory();
  const { applicationState, dispatch } = props;
  const { getCustomerOrderList, pharmaCompletedOrders } = applicationState;
...
const [completedPharmaOrders, setCompletedPharmaOrders] = React.useState(pharmaCompletedOrders);
...
export default CompletedOrdersPharma;
