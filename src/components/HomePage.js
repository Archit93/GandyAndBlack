        ...
        <div className="g-b-insta-landing-page screen">
          ...
          <div className="row">
            <div
              ...
              onClick={() => history.push("/signin")}
            >
              <div className="poppins-normal-white-24px">VIEW MY ACCOUNT</div>
            </div>
            <div
              className="col-lg-4 rectangle-203-uEBdwN"
              onClick={() => history.push("/signup")}
            >
              <div className="poppins-normal-white-24px">CREATE MY ACCOUNT</div>
            </div>
            <div
              className="col-lg-4 rectangle-204-uEBdwN"
